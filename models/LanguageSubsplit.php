...
final class LanguageSubsplit extends Subsplit {
	...
	public function split(Translations $translations): void {
		...
		$dumper = new YamlFileDumper(function (string $id) use ($components, $weblateProject) {
			$component = $components[$id];
			assert($component instanceof Component);
			$url = "https://weblate.rob006.net/projects/{$weblateProject}/{$component->getId()}/{$this->language}/";
